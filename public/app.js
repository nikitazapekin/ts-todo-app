...
(function () {
    ...
    function handleClose() {
        var parent = this.parentElement;
        if (parent) {
            var todoId_1 = parent.dataset.id;
            if (typeof todoId_1 !== 'undefined') {
                var todo = todos.find(function (todo) { return todo.id === todoId_1; });
                if (todo) {
                    deleteTodo(todo);
                }
            }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, fetch("https://jsonplaceholder.typicode.com/todos/".concat(todo.id), {
                                method: 'DELETE',
                                headers: {
                                    'Content-Type': 'application/json',
                                },
